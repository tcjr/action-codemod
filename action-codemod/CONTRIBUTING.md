# Contributing to action-codemod

Open source projects like `action-codemod` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/action-codemod.git
    ```
...
1. [Create a tag](https://github.com/<your-github-handle>/action-codemod/releases/new) and provide release notes. The tag name should match the package version.
